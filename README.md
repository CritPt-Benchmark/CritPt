...
**Nov 21, 2025**: The evaluation pipeline and challenge dataset are now publicly available! To evaluate your own models on CritPt, please follow the instructions provided on this page. 
                  An example challenge can be found [here](https://critpt.com/example.html). See 70 test challenges in [this folder](git data folder link) or on [Hugging Face](https://huggingface.co/datasets/CritPt-Benchmark/CritPt).
